...
SECRET_KEY = 'django-insecure-3i9w+k3*h7ya-gqr$t49n7!kqyu72auck5henuhyk$!san4ex3'
...
INSTALLED_APPS = [
    ...
    'ventas',  # <--- TIENES QUE AÑADIR ESTA LÍNEA AQUÍ
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'concesionaria_db',  # nombre de tu base en pgAdmin
